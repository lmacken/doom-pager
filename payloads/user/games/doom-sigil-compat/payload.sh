#!/bin/bash
# Title: DOOM: SIGIL (Shareware Compatible)
# Description: DOOM: SIGIL (Shareware Compatible)
# Author: @lmacken
# Version: 1.0
# Category: Games

PAYLOAD_DIR="/root/payloads/user/games/doom-sigil-compat"
...
LOG "Starting DOOM: SIGIL (Shareware Compatible)..."
LOG ""
LOG "Controls:"
...
DOOM_ARGS="$DOOM_ARGS -file \"$PAYLOAD_DIR/SIGIL_COMPAT_V1_23.wad\""
