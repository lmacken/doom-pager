#!/bin/bash
# Title: Master Levels
# Description: Master Levels for DOOM II
# Author: @lmacken
# Version: 1.0
# Category: Games

PAYLOAD_DIR="/root/payloads/user/games/doom2-master"
...
# Build command line
DOOM_ARGS="-iwad \"$PAYLOAD_DIR/doom2.wad\""
DOOM_ARGS="$DOOM_ARGS -file \"$PAYLOAD_DIR/masterlevels.wad\""
