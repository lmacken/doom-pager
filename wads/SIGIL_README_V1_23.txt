...
SIGIL_V1_23.txt
SIGIL_README_V1_23.txt (SIGIL Instructions)
SIGIL_V1_23.wad
SIGIL_COMPAT_V1_23.wad

If you paid for the fan boxes (Beast Box or Big Box) or the digital download
...
****
**** To be very clear, this is what's in these two WAD files:
**** SIGIL_V1_23.wad         : MIDI music (free version)
**** SIGIL_V1_23_REG.wad     : Buckethead MP3 music (paid version)
****

You need a version of DOOM to run SIGIL. If you are NOT experienced with the various
flavors of DOOM then you will not need to use SIGIL_COMPAT_V1_23.wad.
...
SIGIL merch is available here: https://www.romero.com
...
**** the latest SIGIL_v1_23.ZIP and install it over your old version.
****
...
from the original much so this unofficial episode five uses the original texture
set for the levels, and adds a new sky like Thy Flesh Consumed did (episode 4).
...
Copy your DOOM.WAD file into the GZDoom directory. Drag and drop SIGIL_v1_23.wad
(or SIGIL_v1_23_REG.wad) onto GZDoom.exe to run it. The SIGIL_V1_23_REG.wad will
play the Buckethead soundtrack, the other one will play the MIDI soundtrack.
...
SIGIL_V1_23.wad (or SIGIL_V1_23_REG.wad) file from the location where you installed
SIGIL (hopefully the same directory as GZDoom).
...
If you want to listen to the MIDI music instead, only drag the SIGIL_V1_23.WAD onto GZDoom.
...
But the only way to score the CO-OPETITION point is to flip the exit switch.
...
are using a version that is very strict, then load the SIGIL_COMPAT_V1_23.wad
so SIGIL will work as an Episode 3 replacement. If you've got the paid version
and wish to load the MP3 soundtrack onto a compatible port that requires the
'COMPAT' wad, you'll need to include the SIGIL_SHREDS_COMPAT.wad file in the
loading order.


I hope you enjoy SIGIL! If you want to drop me an email, I'm john@romero.com.

Cheers,

John Romero
Romero Games Ltd. (C) 2025
